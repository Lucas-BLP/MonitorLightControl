...
from set_screen_res import ScreenRes
import pymsgbox
...
def _iter_physical_monitors(close_handles=True, avoid=None):
...
for handle in _iter_physical_monitors(avoid=0):
    set_vcp_feature(handle, 0x60, 0x11) #Change input to HDMI
    # print("Width =", GetSystemMetrics(0))
    # print("Height =", GetSystemMetrics(1))
    # set_res(GetSystemMetrics(0), GetSystemMetrics(1))
    # print(ctypes.windll.user32.GetSystemMetrics(78), user32.GetSystemMetrics(79))
    input()
